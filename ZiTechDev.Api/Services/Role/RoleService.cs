...
namespace ZiTechDev.Api.Services.Role
{
    public class RoleService : IRoleService
    {
        ...
        private static IQueryable<AppRole> Searching(IQueryable<AppRole> query, RoleFilter filter)
        {
        ...
        private static IQueryable<AppRole> Filtering(IQueryable<AppRole> query, RoleFilter filter)
        {
